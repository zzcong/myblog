# Generated by Django 3.0.6 on 2020-05-16 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='zcblog.Categroy', verbose_name='分类')),
                ('tags', models.ManyToManyField(blank=True, to='zcblog.Tag', verbose_name='标签')),
                ('tui', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='zcblog.Tui', verbose_name='推荐位')),
